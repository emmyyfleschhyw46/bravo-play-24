...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-d8503fe9');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-d8503fe9');}
...
function clearFlash(){dieView.classList.remove('rl-win-d8503fe9');dieView.classList.remove('rl-lose-d8503fe9');if(frameEl){frameEl.classList.remove('rl-win-d8503fe9');frameEl.classList.remove('rl-lose-d8503fe9');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-d8503fe9');if(frameEl){frameEl.classList.add('rl-win-d8503fe9');}}else{dieView.classList.add('rl-lose-d8503fe9');if(frameEl){frameEl.classList.add('rl-lose-d8503fe9');}}
...
var brandEl=document.querySelector('.rl-brand-d8503fe9');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
